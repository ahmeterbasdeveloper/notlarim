...
/// 🏷️ Veritabanı alanları (Sütun İsimleri)
...
class KategoriModel extends Kategori {
  ...
  factory KategoriModel.fromEntity(Kategori entity) {
  ...
  /// 🧱 SQLite'dan (Map) Model'e dönüştürme
  /// Generic Repository okuma yaparken bu metodu kullanacak.
  factory KategoriModel.fromJson(Map<String, dynamic> json) {
    return KategoriModel(
      ...
      kayitZamani: DateTime.parse(json[KategoriAlanlar.kayitZamani] as String),

      // SQLite int (0/1) -> Bool Dönüşümü
      sabitMi: (json[KategoriAlanlar.sabitMi] as int? ?? 0) == 1,
    );
  }

  /// 🗂️ Model'den SQLite'a (Map) dönüştürme
  /// Generic Repository kayıt/güncelleme yaparken bu metodu kullanacak.
  @override
  Map<String, dynamic> toMap() {
    return {
      ...
      // Bool -> SQLite int (0/1) Dönüşümü
      KategoriAlanlar.sabitMi: sabitMi ? 1 : 0,
    };
  }

  /// 🔄 Kopya oluşturmak için (Entity'den gelen copyWith'i override ediyoruz)
  @override
