...
import 'package:notlarim/features/oncelik/domain/usecases/search_oncelik.dart';
...
import '../../domain/usecases/get_first_oncelik.dart';
...
final getFirstOncelikProvider = Provider(
  (ref) => GetFirstOncelik(ref.watch(oncelikRepositoryProvider)),
);

final searchOncelikProvider = Provider(
  (ref) => SearchOncelik(ref.watch(oncelikRepositoryProvider)),
);
