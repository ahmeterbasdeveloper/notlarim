...
import 'package:notlarim/features/kategoriler/domain/usecases/search_kategori.dart';
...
final getFirstKategoriProvider = Provider(
  (ref) => GetFirstKategori(ref.watch(kategoriRepositoryProvider)),
);

final searchKategoriProvider = Provider(
  (ref) => SearchKategori(ref.watch(kategoriRepositoryProvider)),
);
