...
class _HatirlaticiAddEditState extends ConsumerState<HatirlaticiAddEdit> {
  ...
  // Form Alanları için Controller ve Değişkenler
  ...
  void initState() {
    ...
    _baslikController =
        TextEditingController(text: widget.hatirlatici?.baslik ?? '');
    _aciklamaController =
        TextEditingController(text: widget.hatirlatici?.aciklama ?? '');
  ...
  Widget _buildBaslikField(AppLocalizations loc) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintText:
            '${loc.translate('general_enter')} ${loc.translate('general_title')}',
        border: const OutlineInputBorder(),
  ...
  Widget _buildAciklamaField(AppLocalizations loc) {
    return TextFormField(
      controller: _aciklamaController,
      maxLines: 3,
      decoration: InputDecoration(
        labelText: loc.translate('general_explanation'),
        hintText: loc.translate('general_somethingWriteHereMessage'),
        border: const OutlineInputBorder(),
