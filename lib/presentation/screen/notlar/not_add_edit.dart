...
// ✅ EKLEME 1: Renk dönüşümü için Helper importu
...
class _NotAddEditState extends ConsumerState<NotAddEdit> {
  ...
  // ✅ EKLEME 2: Arka plan rengini tutan değişken (Varsayılan beyaz)
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          // ✅ EKLEME 3: Veriler yüklendiğinde rengi güncelle
  ...
  // ✅ EKLEME 4: Seçilen ID'ye göre rengi bulan ve güncelleyen fonksiyon
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // ✅ EKLEME 5: Scaffold background rengini değişkene bağla
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        decoration: InputDecoration(
                          ...
                          // Arka plan rengine göre input arka planını beyaz yapalım ki okunsun
                          filled: true,
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        // ✅ EKLEME 6: Seçim değişince rengi güncelle
                        onChanged: (val) {
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText:
                              local.translate('general_title') ?? 'Başlık',
                          border: const OutlineInputBorder(),
                          filled: true,
                          fillColor: Colors.white.withOpacity(0.5),
                        ),
